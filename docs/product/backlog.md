...
- **Fall semester starts 2026-08-24.** Partner wants early use if ready; **books mid-semester** — **short stories first** (ENGL 1020 schedule recorded under `BL-052`; curation/import can proceed).
