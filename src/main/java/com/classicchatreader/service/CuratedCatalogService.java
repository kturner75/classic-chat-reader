...
public class CuratedCatalogService {
    ...
    private static final List<CuratedCatalogBook> CURATED_BOOKS = List.of(
            ...
            new CuratedCatalogBook(1513, "Romeo and Juliet", "William Shakespeare", 36_000,
                    List.of("Vendetta -- Drama", "Conflict of generations -- Drama"),
                    List.of("Plays", "Tragedy")),
            new CuratedCatalogBook(64317, "The Great Gatsby", "F. Scott Fitzgerald", 35_000,
                    List.of("Long Island (N.Y.) -- Fiction"),
                    List.of("Classics")),
            new CuratedCatalogBook(2641, "A Room with a View", "E. M. Forster", 33_000,
                    List.of("British -- Italy -- Fiction"),
                    List.of("Romance", "Classics")),
            new CuratedCatalogBook(16328, "Beowulf", "Anonymous", 32_000,
                    List.of("Epic poetry, English (Old)"),
                    List.of("Poetry", "Mythology")),
            new CuratedCatalogBook(67979, "The Blue Castle", "L. M. Montgomery", 24_500,
                    List.of("Young women -- Fiction"),
                    List.of("Romance")),
