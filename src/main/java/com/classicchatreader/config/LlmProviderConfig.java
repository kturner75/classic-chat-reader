...
public class LlmProviderConfig {
    ...
    @Value("${ai.reasoning.xai.model:grok-4.20-0309-reasoning}")
    ...
    @Value("${recap.reasoning.xai.model:${ai.reasoning.xai.model:grok-4.20-0309-reasoning}}")
    ...
    @Value("${quiz.reasoning.xai.model:${ai.reasoning.xai.model:grok-4.20-0309-reasoning}}")
